...
export function WhyUsSection() {
  ...
  return <section id="why-us" className="py-12 md:py-24 lg:py-32 bg-gradient-to-bl from-green-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-950 dark:to-blue-950">
