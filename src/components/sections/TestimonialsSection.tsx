...
export function TestimonialsSection() {
  return (
    <section id="engagement" className="bg-transparent py-12 md:py-24 my-0">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <Card className="h-full bg-white/10 backdrop-blur-sm border-white/10 dark:bg-slate-800/10 hover:border-primary/50 transition-all duration-300">
              <CardHeader>
