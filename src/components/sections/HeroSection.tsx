...
export function HeroSection() {
  return (
    <section className="bg-gradient-to-r from-blue-100 via-white to-green-200 dark:from-slate-900 dark:via-slate-950 dark:to-green-700 py-12 md:py-24 lg:py-32 overflow-hidden xl:py-0 rounded-none mx-0 relative">
      {/* World Map Background */}
      <div className="absolute inset-0 opacity-30 overflow-hidden">
        <WorldMap
          dots={[
            {
              start: { lat: 47.6, lng: 5.9 }, // Port-sur-Saône, France (approximate)
              end: { lat: 40.7128, lng: -74.0060 }, // New York
            },
            {
              start: { lat: 47.6, lng: 5.9 }, // Port-sur-Saône, France
