...
export function HeroSection() {
  return <section className="bg-gradient-to-br from-blue-100 via-white to-green-100 dark:from-slate-900 dark:via-slate-950 dark:to-blue-900 py-12 md:py-24 lg:py-32 overflow-hidden xl:py-0 rounded-none mx-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] xl:grid-cols-[1fr_600px] gap-6 lg:gap-12 items-center">
          ...
          <div className="lg:order-last relative">
            ...
            <div className="relative bg-white dark:bg-slate-900 shadow-xl rounded-lg p-6">
              <div className="aspect-video lg:aspect-square bg-gradient-to-tl from-blue-50 to-blue-200 dark:from-slate-800 dark:to-blue-950 rounded-md mb-4 flex items-center justify-center overflow-hidden">
