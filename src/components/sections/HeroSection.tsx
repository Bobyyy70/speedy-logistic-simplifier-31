...
export function HeroSection() {
  return <section className="bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-slate-900 dark:via-slate-950 dark:to-blue-950 py-12 md:py-24 lg:py-32 overflow-hidden mx-px xl:py-[20px] rounded-full">
