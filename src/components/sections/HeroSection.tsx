...
export function HeroSection() {
  return <section className="bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-950 dark:to-blue-950/30 py-12 md:py-24 lg:py-32 overflow-hidden xl:py-0 rounded-none mx-0">
