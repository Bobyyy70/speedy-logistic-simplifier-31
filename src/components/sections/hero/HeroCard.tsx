...
import { UltraLazyMotion } from "@/components/ui/ultra-lazy-motion";

// Inline lightweight icons to avoid pulling lucide-react into the critical path
...
export function HeroCard() {
  return (
    <div className="lg:order-last relative">
      {/* Static decorative glow (no JS animation required) */}
      <div 
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              <CheckCircleIcon className="h-4 w-4 text-[#2F68F3]" />
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              <ClockIcon className="h-4 w-4 text-[#F3BA2F]" />
