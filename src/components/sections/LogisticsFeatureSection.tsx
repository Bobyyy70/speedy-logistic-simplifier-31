      ...
      <div className="container mx-auto px-4 mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {checkItems.map((item, index) => (
            <motion.div
              key={index}
              className="bg-white justify-content-center dark:bg-slate-800/20 backdrop-blur-sm rounded-10 rounded-lg p-6 shadow-sm border border-gray-100/20 dark:border-gray-700/20"
              custom={index}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
