...
export function ChallengesSection() {
  ...
  return <section id="challenges" className="py-12 md:py-24 lg:py-32 bg-gradient-to-br from-green-50/80 via-blue-50/50 to-green-50/70 dark:from-green-950/20 dark:via-blue-950/20 dark:to-green-950/20">
