...
export function ChallengesSection() {
  ...
  return <section id="challenges" className="py-12 md:py-24 lg:py-32 bg-gradient-to-tr from-green-100 via-white to-green-200 dark:from-slate-900 dark:via-slate-950 dark:to-emerald-800">
