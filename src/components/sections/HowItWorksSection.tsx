...
export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="py-12 md:py-24 bg-white dark:bg-slate-900 lg:py-[34px]">
            ...
            <TabsList className="grid w-full grid-cols-4 mb-8 gap-2">
              {steps.map(step => (
                <TabsTrigger 
                  key={step.id} 
                  value={step.id} 
                  className="flex flex-col items-center py-3 px-1 sm:px-4 data-[state=active]:text-orange-600 dark:data-[state=active]:text-orange-400 bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700 font-medium text-base rounded-lg shadow-sm"
                >
