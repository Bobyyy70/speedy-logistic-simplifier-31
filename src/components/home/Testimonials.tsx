...
export function Testimonials() {
  return (
    <section className="bg-gradient-to-r from-green-200 via-white to-blue-100 dark:from-green-900 dark:via-slate-950 dark:to-slate-900 py-12 md:py-20">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="bg-gradient-to-r from-white via-white to-blue-50 dark:from-slate-900 dark:via-slate-950 dark:to-blue-950 border-0 shadow-md">
