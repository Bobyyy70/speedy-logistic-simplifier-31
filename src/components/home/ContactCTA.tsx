  ...
  return (
    <section className="py-16 md:py-24 lg:py-32 px-0 relative overflow-hidden">
      ...
      <div className="section-container py-0 my-0 px-4 md:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto backdrop-blur-sm p-8 rounded-xl border border-white/10 dark:border-slate-700/10 bg-white/30 dark:bg-slate-900/30 shadow-xl">
