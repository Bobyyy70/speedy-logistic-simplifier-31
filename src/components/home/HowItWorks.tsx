    ...
    <section className="bg-gray-50 py-12 md:py-20">
      <div className="section-container">
        ...
        <div className="mt-16 relative">
          <div className="hidden md:block absolute left-0 right-0 top-24 h-0.5 bg-gray-200"></div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="relative z-10 flex flex-col items-center">
                  <div className="bg-primary text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg shadow-md mb-4">
                    {step.number}
                  </div>
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute right-0 top-6 transform translate-x-1/2 text-gray-300">
