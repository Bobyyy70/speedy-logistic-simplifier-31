...
const Services = () => {
  ...
  return (
    <div className="w-full">
      <div className="w-full py-16 px-4 bg-gradient-to-r from-blue-100 via-white to-green-200 dark:from-slate-900 dark:via-slate-950 dark:to-green-700">
      ...
      <div className="relative bg-gradient-to-l from-blue-100 via-white to-green-200 dark:from-slate-900 dark:via-slate-950 dark:to-green-700">
        <ServicesSection />
        <div className="absolute top-1/2 right-4 w-8 h-8 rounded-full bg-orange-100/30 dark:bg-orange-900/30" />
      </div>

      <div className="relative bg-gradient-to-r from-blue-100 via-white to-green-200 dark:from-slate-900 dark:via-slate-950 dark:to-green-700">
