...
const About = () => {
  ...
  return <div className="content-section-bg">
      <Helmet>
      ...
      <section className="py-10 md:py-24 content-section-bg">
      ...
      <section className="py-10 md:py-20 content-section-bg">
      ...
      <section className="py-12 md:py-20 content-section-bg text-center">
        <div className="container mx-auto px-4">
