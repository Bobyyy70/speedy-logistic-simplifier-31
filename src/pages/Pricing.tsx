...
const Pricing = () => {
  ...
  return <div className="bg-gradient-to-br from-green-50 via-green-50/50 to-green-100/30 dark:from-slate-900 dark:via-slate-950 dark:to-emerald-950">
      <Helmet>
      ...
      <div className="container mx-auto py-12 px-4 text-center">
        <div className="max-w-2xl mx-auto bg-blue-50/50 p-6 rounded-lg">
          <h3 className="text-xl font-semibold mb-3 py-[50px]">Information importante</h3>
